...
public class PackedJsonModContainer implements ModContainerExt {
    ...
    PackedJsonModContainer(ExampleLoaderPlugin plugin, Path rootPath, List<List<Path>> sourcePaths, ModMetadataExt metadata) {
